<div class="br-logo"><a href="http://localhost/Big-Smoke_2.0/view/Admin_Home/"><span>[</span>Big-Smoke<span>]</span></a></div>
    <div class="br-sideleft overflow-y-auto">
      <label class="sidebar-label pd-x-15 mg-t-20">Administración</label>
      <div class="br-sideleft-menu">
        <a href="http://localhost/Big-Smoke_2.0/view/Admin_Home/" class="br-menu-link" id="btnUsuario">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            <span class="menu-item-label">Usuario</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="http://localhost/Big-Smoke_2.0/view/Admin_Prod/" class="br-menu-link" id="btnProductos">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
            <span class="menu-item-label">Productos</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="http://localhost/Big-Smoke_2.0/view/Admin_Ventas/" class="br-menu-link" id="btnCompra">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Ventas/Compras</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
          ...
          <div class="dropdown">
            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    ...
                    <img src="<?php echo $_SESSION["Avatar"] ?>" class="wd-32 rounded-circle" alt="">
                ...
                <ul class="list-unstyled user-profile-nav">
                    ...
                    <li><a href="../html/logout.php"><i class="icon ion-power"></i> Sign Out</a></li>
                </ul>
                </div><!-- dropdown-menu -->
            </div><!-- dropdown -->
        </nav>
